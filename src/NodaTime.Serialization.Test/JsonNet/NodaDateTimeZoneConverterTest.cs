...
namespace NodaTime.Serialization.Test.JsonNet
{
    public class NodaDateTimeZoneConverterTest
    {
        ...
        public void Deserialize_TimeZoneNotFound()
        {
            ...
            JsonSerializationException ex = Assert.Throws<JsonSerializationException>(() => JsonConvert.DeserializeObject<DateTimeZone>(json, converter));
            Assert.IsInstanceOf<DateTimeZoneNotFoundException>(ex.InnerException);
        }
    }
}
